...
class SMPLDataset(Dataset):
    def __init__(self, args, data_split, dataset): # data_split: train/test; dataset: h36m, coco, pw3d
        ...
        self.pred_motion_smpl_3d = {'train': {'pose': pred_smpl_pose_train, 'shape': pred_smpl_shape_train}, 'test': {'pose': pred_smpl_pose_test, 'shape': pred_smpl_shape_test}}[data_split]
        self.smpl = SMPL(
            args.data_root,
            batch_size=1,
        )
