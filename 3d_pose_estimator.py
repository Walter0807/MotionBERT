...
def process_one_image(
    args, img, detector, pose2d_estimator, pose3d_estimator, visualizer=None, show_interval=0
):
    ...
    coord_with_score = halpe2h36m(pose_prediction['keypoints'], pose_prediction['keypoint_scores'], img.shape[:2])
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="for specifying the webcam ID"
    )
    ...
    visualizer = VISUALIZERS.build(pose2d_estimator.cfg.visualizer)
    ...
    while cap.isOpened():
        ...
        process_one_image(
            args, frame, detector, pose2d_estimator, pose3d_estimator, visualizer, 0.001
        )
